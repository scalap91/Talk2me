...
import { UserPlus, Sparkles, Users, X, Check, Store, Loader2, MessageCircle, ShoppingBag, UtensilsCrossed, Trash2, Phone, Contact } from 'lucide-react';
...
export default function FriendsHubPage() {
  ...
  return (
    <div className="flex flex-col h-[100svh] w-full max-w-md lg:max-w-4xl mx-auto bg-[#0e0e12] overflow-hidden">
      <header className="sticky top-0 z-40 flex h-14 items-center justify-between border-b border-white/8 bg-[#0e0e12]/85 px-4 backdrop-blur-xl">
        ...
        <div className="flex items-center gap-2.5">
          ...
          {/* Contacts : retrouver ses amis du répertoire + inviter (sans profit) */}
          <button
            type="button"
            onClick={() => router.push('/contacts')}
            aria-label="Mes contacts"
            data-testid="friends-contacts"
