...
export default function RdAvatarPage() {
  ...
  return (
    <main style={{ position: 'fixed', inset: 0, background: '#0d0d12', overflow: 'hidden', touchAction: 'none' }}>
      ...
      <a href="/home" style={{ position: 'fixed', top: 12, left: 12, zIndex: 9, padding: '8px 14px', borderRadius: 999, background: 'rgba(0,0,0,.55)', color: '#fff', fontFamily: 'system-ui', fontSize: 13, fontWeight: 600, textDecoration: 'none' }}>← Quitter R&D</a>
      {phase === 'view' && (
