...
const FEATURES: LabItem[] = [
  ...
  { emoji: '💸', title: 'Reversement manuel', desc: 'Finance de secours : liste les bénéficiaires à payer (solde wallet crédité par l’escrow à la livraison) → l’admin envoie le mobile money à la main puis « J’ai versé » (débit wallet + trace + Telegram). Parqué — le payout AUTO (PaPi/Paysend) prend le relais.', href: '/admin/payouts', status: 'parqué' },
