...
export default function NotFound() {
  return (
    <div className="min-h-[100svh] bg-[var(--t2m-paper)] text-[var(--t2m-ink)] flex flex-col items-center justify-center gap-5 px-6 text-center">
      ...
      <p className="text-[var(--t2m-ink-3)] text-[14px] max-w-xs">
