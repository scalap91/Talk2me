  ...
  return (
    <main style={{ position: 'fixed', inset: 0, background: '#15151c' }}>
      ...
      >
        ...
        <span style={{ position: 'absolute', inset: 4, borderRadius: '6px 6px 2px 2px', background: 'linear-gradient(160deg,#6f4f30,#4a3320)', border: '1px solid rgba(0,0,0,.35)' }} />
        <span style={{ position: 'absolute', left: 11, right: 11, top: 11, height: 34, borderRadius: 4, background: 'rgba(0,0,0,.18)', boxShadow: 'inset 0 0 0 2px rgba(255,255,255,.06)' }} />
        <span style={{ position: 'absolute', left: 11, right: 11, top: 51, height: 40, borderRadius: 4, background: 'rgba(0,0,0,.18)', boxShadow: 'inset 0 0 0 2px rgba(255,255,255,.06)' }} />
        <span style={{ position: 'absolute', right: 11, top: 52, width: 8, height: 8, borderRadius: 999, background: '#f4d58d', boxShadow: '0 0 7px rgba(244,213,141,.85)' }} />
        <span style={{ position: 'absolute', left: '50%', transform: 'translateX(-50%)', bottom: -22, whiteSpace: 'nowrap', padding: '3px 10px', borderRadius: 999, background: 'rgba(0,0,0,.6)', color: '#fff', fontFamily: 'system-ui', fontSize: 12, fontWeight: 700 }}>Sortir</span>
      </button>
