  ...
  return (
    <motion.div ref={cardRef}
      ...
      style={variant === 'long'
        ...
        ? { position: 'relative', backgroundColor: 'var(--t2m-card-bg)', padding: longImmersive ? 0 : '16px 16px 20px', overflow: longImmersive ? 'hidden' : undefined, display: 'flex', flexDirection: 'column', borderBottom: longImmersive ? 'none' : '8px solid var(--t2m-wash)' }
