...
echo "==> 4/6  Modèles IA — CŒUR : images (FLUX) + transcription + serveur"
# transformers < 5 = compat FLUX/diffusers (transformers 5.x trop récent casse FLUX)
pip install \
...
echo "==> 4bis  Voix XTTS (OPTIONNEL — fork compatible Python 3.12, n'arrête pas le script si échec)"
pip install coqui-tts || echo "!! Voix non installée (Python 3.12). Les IMAGES marchent quand même. On réglera la voix après."
