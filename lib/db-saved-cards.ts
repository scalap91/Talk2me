...
/**
 * lib/db-saved-cards — section « saved_cards » (cards enregistrées par l'user)
 * extraite du monolithe lib/db.ts (façade #53, Pascal 2026-06-30). lib/db.ts
 * re-exporte → appelants inchangés. Connexion = getDb(). Tables créées par l'init.
 */
