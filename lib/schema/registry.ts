...
export const MODULES: ModuleEntry[] = [
  M({
    ...
    bugs: [
      ...
      '✅ [FAUX POSITIF vérifié] music — la musique MARCHE : /api/music/trending renvoie 50 sons (music-hub port 3020 online, clé dans .env, BASE_URL défaut 127.0.0.1:3020). L audit avait lu .env.local sans tester le live. NOTE prod multi-serveur : poser MUSIC_HUB_BASE_URL si music-hub sur une autre machine',
      '🟠 music — mode DJ démarre liste VIDE en SILENCE si music-hub down (pas de feedback user) (DJConsole.tsx:51-53) — seul point à durcir',
